...
Yes,  the Hessian matrix does not depend on $Y_i$, and we can achieve $I(\beta) = - E[H]  = - H$

$$
H(\beta)=-\sum_{i=1}^n X_i X_i^T \frac{\phi\left(X_i^T \beta\right)^2}{\Phi\left(X_i^T \beta\right)\left(1-\Phi\left(X_i^T \beta\right)\right)}
$$
